...
// Data type
    // String Type
    $string = "Hello, World!";
    echo $string; // Result: Hello, World!
    // Interger Type
    $integer = 42;
    echo $integer; // Result: 42
    //Float Type
    $float = 3.14159;
    echo $float; // Result: 3.14159
    //boolean Type
    $booleanTrue = true;
    $booleanFalse = false;
    echo $booleanTrue ? 'True' : 'False'; // Result: TrueResult: y=10

//Function - Pass value to function by reference

    function tangGT(&$value) {
        $value += 10; // Increase the variable value to 10
    }
